 ...
 * under the License.
 *
 * The Original Code is ASPostingInRun.java
 *
...
public class ASPostingInRun extends SimplePostingInRun {
	public ASPostingInRun() {
		super();
	}
...
//				bos.writeGamma(postingSource.readGamma());
				bos.writeBinary(32, postingSource.readBinary(32));
			}
		}
		try{
			postingSource.align();
