                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="indexes"><g:message code="imageCollection.indexes.label" default="Indexes" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: imageCollectionInstance, field: 'indexes', 'errors')}">
                                    <g:select name="indexes" from="${org.imageterrier.webapp.ImageTerrierIndex.list()}" multiple="yes" optionKey="id" size="5" value="${imageCollectionInstance?.indexes*.id}" />
                                </td>
                            </tr>
