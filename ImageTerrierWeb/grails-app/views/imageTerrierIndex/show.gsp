		...
		<div class="body">
					...
					<tbody>
						...
						<tr class="prop">
							...
							<td valign="top" style="text-align: left;" class="value">
								<ul>
								<g:each in="${imageTerrierIndexInstance.imageCollection}" var="c">
			...
			<div class="buttons">
				<g:form action="delete">
					...
					<span class="button"><g:submitButton name="delete" class="delete" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" /></span>
				</g:form>
			</div>
		</div>
	</body>
